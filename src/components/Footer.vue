        ...
        <div class="row">
          <div class="col-lg-5 col-xl-4 col-md-5 col-sm-4 col-xs-12">
                <ul class="adress">
                        ...
                        <li>
                         <p>Building 1, <br> Chalfont Park, <br> Chalfont St Peter <br> Gerrads Cross, <br> SL9 0BG</p>
                        </li>
                        <li>
                        <p>Tel: 01895 619 900 <br> Email: hello@considerthisuk.com <br> Web: considerthisuk.com</p>
                        </li>
                        <li>
                        <p></p>
                        </li>
