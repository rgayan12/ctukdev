    ...
    <div>
          <div class="container ">
            ...
            <div class="row text-left">
               <div class="col-md-6 col-xl-6" v-for="item in casestudies" v-bind:key="item.id">
                   <div class="card">
                       <div class="card-body">
                        <router-link :to="{ name: 'CaseStudy', params: { id: item.slug}}"><h5>{{item.title}}</h5></router-link>
