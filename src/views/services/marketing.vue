...
export default {
  ...
  methods:{
      ...
      this.$http
        .get(
          "http://twinkle.consider-this.co.uk/ctuk-backend/items/primary_services/1?fields=secondary_services.name,secondary_services.description,secondary_services.image.filename_disk,intro_text,name&[secondary_services.status]=published"
        )
        .then(response => {
